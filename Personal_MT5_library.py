...
class MT5:
    ...
    def run(symbol, buy, sell, lot, pct_tp=0.02, pct_sl=0.01, comment="", magic=23400):
        ...
        if buy == True and position == 0:
            ...
            res = MT5.send_order(symbol, lot, True, False, id_position=identifier, pct_tp=pct_tp, pct_sl=pct_sl,
            ...
            before = mt5.account_info().balance
            res = MT5.send_order(symbol, lot, False, True, id_position=identifier, pct_tp=pct_tp, pct_sl=pct_sl,
                                 comment=" No specific comment", magic=0)
        ...
        """ Buy or Sell """
        if buy == True:
            res = MT5.send_order(symbol, lot, True, False, id_position=None, pct_tp=pct_tp, pct_sl=pct_sl,
                                 comment=" No specific comment", magic=0)
        ...
        if sell == True:
            res = MT5.send_order(symbol, lot, False, True, id_position=None, pct_tp=pct_tp, pct_sl=pct_sl,
                                 comment=" No specific comment", magic=0)
